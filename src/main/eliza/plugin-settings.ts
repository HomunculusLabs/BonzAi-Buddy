...
interface LoadedPluginInventory {
...
export class BonziPluginSettingsStore {
  ...
  private readPersistedPluginInventory(): LoadedPluginInventory {
  ...
  private normalizeParsedSettings(parsed: unknown): LoadedPluginInventory {
    if (!isRecord(parsed)) {
      return {
        inventory: {},
        needsRewrite: true,
